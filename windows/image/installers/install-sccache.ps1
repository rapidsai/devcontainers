...
Invoke-WebRequest -Uri "https://github.com/rapidsai/sccache/releases/download/v0.11.0-rapids.0/sccache-v0.11.0-rapids.0-x86_64-pc-windows-msvc.zip" -OutFile "./sccache.zip" -UseBasicParsing
