...
Invoke-WebRequest -Uri "https://github.com/rapidsai/sccache/releases/download/v0.12.0-rapids.27/sccache-v0.12.0-rapids.27-x86_64-pc-windows-msvc.zip" -OutFile "./sccache.zip" -UseBasicParsing
