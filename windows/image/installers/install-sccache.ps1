...
Invoke-WebRequest -Uri "https://github.com/rapidsai/sccache/releases/latest/download/sccache-x86_64-pc-windows-msvc.zip" -OutFile "./sccache.zip" -UseBasicParsing
